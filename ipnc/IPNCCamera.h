//
// Created by xujun on 19-9-17.
//

#ifndef FACEPICTURECLIENT_IPNCCAMERA_H
#define FACEPICTURECLIENT_IPNCCAMERA_H
...
class IPNCCamera {
public:
    IPNCCamera(void *pUser, const char *cCameraIP, const int nPort, const char *cUserName, const char *cPassword,
...
#endif //FACEPICTURECLIENT_IPNCCAMERA_H
