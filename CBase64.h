//
// Created by carl on 18-10-17.
//

#ifndef FACEPICTURECLIENT_CBASE64_H
#define FACEPICTURECLIENT_CBASE64_H
...
public:
    ...
    * 返回值  ：true处理成功,false失败
    **********************************************************/
    bool static Decode(const unsigned char *pIn, unsigned long uInLen, unsigned char *pOut, uint64_t *uOutLen) ;
};


#endif //FACEPICTURECLIENT_CBASE64_H
